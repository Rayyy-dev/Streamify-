...
<template>
  <div>
    ...
    <div id="SideNav" class="h-[100%] w-[240px] fixed z-50 bg-black flex flex-col">
      ...
      <div class="mt-6 px-6">
        <ul>
          <li class="flex items-center text-gray-300 hover:text-white cursor-pointer mb-4">
            <div class="bg-gray-400 rounded-sm p-1 mr-4">
              <PlusIcon :size="18" fillColor="#000000" />
            </div>
            <span class="text-sm font-semibold">Create Playlist</span>
          </li>
          <li class="flex items-center text-gray-300 hover:text-white cursor-pointer">
            <div class="bg-gradient-to-br from-purple-700 to-blue-300 rounded-sm p-1 mr-4">
              <HeartIcon :size="18" fillColor="#FFFFFF" />
            </div>
            <span class="text-sm font-semibold">Liked Songs</span>
          </li>
        </ul>
      </div>
      <div class="border-b border-b-gray-800 mt-4 mx-6"></div>
      <div class="mt-4 px-6 flex-grow overflow-y-auto">
        <ul>
          <li v-for="playlist in playlists" :key="playlist.id" 
              class="text-[13px] text-gray-300 hover:text-white cursor-pointer py-1.5 truncate">
            {{ playlist.name }}
          </li>
        </ul>
      </div>
