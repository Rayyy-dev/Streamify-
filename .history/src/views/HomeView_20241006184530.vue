  ...
  <div class="p-8 bg-gray-900">
    <section v-for="(section, index) in sections" :key="index" class="mb-12">
      <div class="flex justify-between items-center mb-6">
        ...
        <button @click="seeAll(section.title)" class="text-gray-400 hover:text-white transition-colors text-sm font-semibold">See All</button>
      </div>
...
const seeAll = (sectionTitle) => {
  // Navigate to a new route for the full section view
  router.push({ name: 'fullSection', params: { title: sectionTitle } });
};
</script><style scoped>
