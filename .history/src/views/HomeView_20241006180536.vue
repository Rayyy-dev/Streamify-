<template>
  <div class="p-8 bg-gray-900">
    <section v-for="(section, index) in sections" :key="index" class="mb-12">
      ...
      <div class="relative">
        <button @click="scroll(index, 'left')" class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 opacity-75 hover:opacity-100">
        ...
        <button @click="scroll(index, 'right')" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full z-10 opacity-75 hover:opacity-100">
