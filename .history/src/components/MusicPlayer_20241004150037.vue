    ...
    ">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4 w-1/4">
                <img class="w-12 h-12 rounded-full object-cover" :src="currentArtist.albumCover">
                <div>
                    <div class="text-white font-medium truncate">{{ currentTrack.name }}</div>
                    <div class="text-gray-400 text-sm truncate">{{ currentArtist.name }}</div>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center w-2/4">
                ...
                <div class="w-full flex items-center space-x-2">
                    ...
                    <div class="flex-grow relative">
                        <input v-model="range" type="range" class="w-full h-1 bg-gray-700 rounded-lg appearance-none cursor-pointer">
                        <div class="absolute top-0 h-1 bg-white rounded-lg" :style="`width: ${range}%`"></div>
                    </div>
