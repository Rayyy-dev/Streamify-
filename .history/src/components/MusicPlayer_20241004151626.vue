...
<template>
    <div id="MusicPlayer" v-if="audio" class="
        ...
        border-t border-gray-700 py-3 px-4
    ">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4 w-1/4">
                <img class="w-14 h-14 rounded-lg object-cover shadow-lg" :src="currentArtist.albumCover">
                <div>
            ...
            <div class="flex flex-col items-center w-2/4">
                <div class="flex items-center space-x-6 mb-2">
                    ...
                    <button @click="useSong.playOrPauseThisSong(currentArtist, currentTrack)" 
                        ...
                        <Play v-if="!isPlaying" fillColor="#000000" :size="22" />
                        <Pause v-else fillColor="#000000" :size="22" />
                    </button>
                ...
                <div class="w-full flex items-center space-x-2">
                    ...
                    <div class="flex-grow relative">
                        <input v-model="range" type="range" class="w-full h-1 bg-gray-700 rounded-full appearance-none cursor-pointer">
