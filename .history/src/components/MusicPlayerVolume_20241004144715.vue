...
<template>
    <VolumeMute v-if="vol == 0" fillColor="#E0E7FF" :size="22" />
    <VolumeHigh v-else fillColor="#E0E7FF" :size="22" />
    <div class="flex items-center ml-3 w-[160px] relative mt-2 mb-[23px]" @mouseenter="isHover = true"
