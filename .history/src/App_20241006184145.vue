...
const unreadNotifications = ref(3) // Example value, replace with actual logic
  ...
  <div>
    ...
    <div id="TopNav" class="w-[calc(100%-240px)] h-[60px] fixed right-0 z-20 bg-[#101010] bg-opacity-80 flex items-center justify-between">
      ...
      <div class="flex items-center mr-8">
        <button @click="toggleNotifications" class="text-white mr-4 relative">
          <BellIcon :size="20" />
          <span v-if="unreadNotifications" class="absolute -top-1 -right-1 bg-red-500 rounded-full w-4 h-4 text-xs flex items-center justify-center">{{ unreadNotifications }}</span>
        </button>
        ...
        <span v-if="openMenu"
          ...
          <ul class="text-gray-200 font-semibold text-[14px]">
            <li @click="goToProfile" class="px-3 py-2.5 hover:bg-[#3E3D3D] border-b border-b-gray-600">Profile</li>
