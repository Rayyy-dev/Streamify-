      ...
      <div class="mt-6 px-2 flex-grow overflow-y-auto">
        ...
        <ul>
          <li v-for="playlist in playlists" :key="playlist.id" class="mb-1">
            <button @click="playlistStore.selectPlaylist(playlist.id)" class="flex items-center w-full py-2 px-4 text-gray-300 hover:text-white transition-colors rounded-md hover:bg-gray-900">
